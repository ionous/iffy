...
func imp_property_phrase(k *Importer, kind ephemera.Named, r reader.Map) (err error) {
...
func imp_primitive_phrase(k *Importer, kind ephemera.Named, r reader.Map) (err error) {
...
func imp_aspect_phrase(k *Importer, kind ephemera.Named, r reader.Map) (err error) {
...
func imp_optional_property(k *Importer, r reader.Map) (ret ephemera.Named, err error) {
